...
const NavbarIcons = () => {
  ...
  const notifications = [
    {
      ...
      description:
        "Lorem ipsum dolor sit, amet consectetur adipisicing elit. At maxime eos laborum id hic obcaecati reprehenderit enim totam dolorem nesciunt?",
    },
    {
  ...
  return (
    <div className="flex items-center gap-6">
      {/* Add Icon */}
      <button className="text-gray-300 hidden md:block hover:text-white transition-colors">
        <CirclePlus />
      </button>
